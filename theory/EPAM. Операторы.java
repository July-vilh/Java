...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(aLessthanB);
    }
}

//РЕЗУЛЬТАТ: true

!!!!! КАК ВЫВОД: ПРИ СРАВНЕНИИ ОДНОГО ЧИСЛА С ДРУГИМ ЧЕРЕЗ ОПЕРАТОРЫ СРАВНЕНИЯ И ПРИ ИСПОЛЬЗОВАНИИ ОПЕРАТОРОВ И/ИЛИ РЕЗУЛЬТАТ АВТОМАТИЧЕСКИ ВСЕГДА ДОЛЖЕН БЫТЬ BOOLEAN !!!!!
